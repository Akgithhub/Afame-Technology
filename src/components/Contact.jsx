      ...
      <div id="contact" className=" flex flex-col justify-center items-center">
        <motion.h1 {...animations.h1}>
          ...
          <div className="flex justify-center items-center">
            <div className="hover:scale-125 transition-all mb-[6vh]">
            ...
            <h1 className="hover:text-green-900 hover:scale-125 transition-all hover:font-semibold text-[2vh] font-bold text-green-800 ">Amaan Khan</h1>
            <div className="hover:scale-125 transition-all mb-[6vh]">
            ...
            <h1 className="hover:text-green-900 hover:scale-125 transition-all hover:font-semibold text-[2vh] font-bold text-green-800 ">Antariksh</h1>
          </div>
        </motion.h1>
      </div>
    </>
